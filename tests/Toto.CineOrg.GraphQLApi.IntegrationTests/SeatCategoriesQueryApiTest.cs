...
{
    public class SeatCategoriesQueryApiTest : IClassFixture<InMemorySqliteApplicationFactory<Startup>>
    {
        private readonly GraphQLHttpClient _graphQlHttpClient;
        
        public SeatCategoriesQueryApiTest(InMemorySqliteApplicationFactory<Startup> factory)
        {
